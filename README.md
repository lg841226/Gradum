...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Release-v1.0.2--experimental-6f42c1?style=flat" alt="v1.0.2-experimental"/>
...
- `gradum@1.0.2-experimental.jar`: cross-platform fat jar (requires Java 21)
...
```bash
./gradlew build
java -jar gradum@1.0.2-experimental.jar
```
...
`--host/--port/--auto-port/--api-key` flags were removed. `java -jar gradum@1.0.2-experimental.jar --help` still prints
