 ...
 *
 * GradumMarkdownStyling.kt  2026-07-08 14:57:38 Changed by gwy
 */
...
fun rememberGradumMarkdownStyling(): MarkdownStyling {
    ...
    val inlineCodeTextStyle = editorTextStyle.copy(
        lineHeight = editorTextStyle.fontSize * 1.5f,
        color = badgeBlue,
        background = badgeBlue.copy(alpha = 0.12f)
    )
    val bodyTextStyle: TextStyle = JewelTheme.typography.labelTextStyle
    val paragraphTextStyle: TextStyle = bodyTextStyle.copy(lineHeight = bodyTextStyle.fontSize * 1.5f)

    return remember(globalColors, editorTextStyle, linkStyle, badgeBlue, paragraphTextStyle) {
