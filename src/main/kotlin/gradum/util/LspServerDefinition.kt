 ...
 *
 * LspServerDefinition.kt  2026-06-21 07:53:44 Changed by gwy
 */
...
object LspServerRegistry {
    val KNOWN_SERVERS: List<LspServerDefinition> = listOf(
        LspServerDefinition(
            languageId = "kotlin",
    ...
    fun findByPath(path: Path): LspServerDefinition? = KNOWN_SERVERS.firstOrNull { it.matches(path) }
}
 ...
 */
fun isLspServerInstalled(spec: LspServerDefinition): Boolean {
