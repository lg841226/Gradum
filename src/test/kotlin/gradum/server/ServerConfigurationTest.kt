 ...
 *
 * ServerConfigurationTest.kt  2026-08-09 19:59:00 Changed by gwy
 */
...
class ServerConfigurationTest {
  ...
  fun `default configuration binds localhost on port 8765`() {
    ...
    assertEquals("localhost", configuration.hostAddress)
    assertEquals(8765, configuration.portNumber)
  }
  ...
  fun `explicit host and port are preserved`() {
    ...
    assertEquals("127.0.0.1", configuration.hostAddress)
    assertEquals(9999, configuration.portNumber)
  }
